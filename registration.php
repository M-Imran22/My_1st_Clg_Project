    ...
    <div class="wrapper" style="height: 520px;">
        ...
        <div class="form-box login">
            ...
            <?php if (isset($_SESSION["error"])) : ?>
                ...
                <p class="error">Account already exist !</p>
            <?php endif; ?>
            <form method="post" action="http://127.0.0.1/modified_project/registration_data.php">
                <div class="input-box">
                ...
                <div class="login-register">
                    <p>Already have an account? <a href="http://127.0.0.1/modified_project/login.php" class="login-link">Login</a></p>
                </div>
